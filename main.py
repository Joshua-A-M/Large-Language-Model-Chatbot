...
#   ouptut neatly lays out the architecture
#   the GPTModel consists of embedding layers followed by 12 identical transformer blocks,
#   folllowed by a final LayerNorm  and the output layer, out_head
print(model)
...
#   there is little to no indicatoin of overfitting
...
#   use the fine-tuned GPT-based system classificaton model
